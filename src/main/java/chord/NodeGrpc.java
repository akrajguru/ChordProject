...
public final class NodeGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<chord.Chord.CheckKeyRequest,
      chord.Chord.CheckKeyReply> getCheckKeyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "checkKey",
      requestType = chord.Chord.CheckKeyRequest.class,
      responseType = chord.Chord.CheckKeyReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<chord.Chord.CheckKeyRequest,
      chord.Chord.CheckKeyReply> getCheckKeyMethod() {
    io.grpc.MethodDescriptor<chord.Chord.CheckKeyRequest, chord.Chord.CheckKeyReply> getCheckKeyMethod;
    if ((getCheckKeyMethod = NodeGrpc.getCheckKeyMethod) == null) {
      synchronized (NodeGrpc.class) {
        if ((getCheckKeyMethod = NodeGrpc.getCheckKeyMethod) == null) {
          NodeGrpc.getCheckKeyMethod = getCheckKeyMethod =
              io.grpc.MethodDescriptor.<chord.Chord.CheckKeyRequest, chord.Chord.CheckKeyReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "checkKey"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  chord.Chord.CheckKeyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  chord.Chord.CheckKeyReply.getDefaultInstance()))
              .setSchemaDescriptor(new NodeMethodDescriptorSupplier("checkKey"))
              .build();
        }
      }
    }
    return getCheckKeyMethod;
  }
  ...
  public static abstract class NodeImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void checkKey(chord.Chord.CheckKeyRequest request,
        io.grpc.stub.StreamObserver<chord.Chord.CheckKeyReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCheckKeyMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                chord.Chord.CheckKeyRequest,
                chord.Chord.CheckKeyReply>(
                  this, METHODID_CHECK_KEY)))
          .build();
    }
  }
  ...
  public static final class NodeStub extends io.grpc.stub.AbstractAsyncStub<NodeStub> {
    ...
    public void checkKey(chord.Chord.CheckKeyRequest request,
        io.grpc.stub.StreamObserver<chord.Chord.CheckKeyReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCheckKeyMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class NodeBlockingStub extends io.grpc.stub.AbstractBlockingStub<NodeBlockingStub> {
    ...
    /**
     */
    public chord.Chord.CheckKeyReply checkKey(chord.Chord.CheckKeyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getCheckKeyMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class NodeFutureStub extends io.grpc.stub.AbstractFutureStub<NodeFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<chord.Chord.CheckKeyReply> checkKey(
        chord.Chord.CheckKeyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getCheckKeyMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_CHECK_KEY = 9;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_SUCCESSOR_OF_NODE:
          serviceImpl.getSuccessorOfNode((chord.Chord.SuccessorOfNodeRequest) request,
              (io.grpc.stub.StreamObserver<chord.Chord.SuccessorOfNodeResponse>) responseObserver);
          break;
        case METHODID_CHECK_KEY:
          serviceImpl.checkKey((chord.Chord.CheckKeyRequest) request,
              (io.grpc.stub.StreamObserver<chord.Chord.CheckKeyReply>) responseObserver);
          break;
        default:
